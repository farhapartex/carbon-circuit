...
REVOKE ALL ON SCHEMA billing FROM identity_service, provenance_service, evidence_service;
REVOKE ALL ON SCHEMA identity FROM billing_service, provenance_service, evidence_service;
REVOKE ALL ON SCHEMA provenance FROM identity_service, billing_service, provenance_read_service, evidence_service;
REVOKE ALL ON SCHEMA provenance_read FROM identity_service, billing_service, provenance_service, evidence_service;

REVOKE ALL ON SCHEMA evidence FROM identity_service, billing_service, provenance_service, provenance_read_service;
