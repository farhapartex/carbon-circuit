...
const ServiceName = "sustainability-service"
...
func Load() (Config, error) {
	...
	config := Config{
		...
		GRPCAddress:     loader.StringDefault("GRPC_ADDRESS", ":9096"),
		...
		DatabaseSchema:  loader.StringDefault("DATABASE_SCHEMA", "sustainability"),
