...
const ServiceName = "credit-ledger-service"
...
func Load() (Config, error) {
	...
	config := Config{
		...
		GRPCAddress:     loader.StringDefault("GRPC_ADDRESS", ":9097"),
		...
		DatabaseSchema:  loader.StringDefault("DATABASE_SCHEMA", "credit_ledger"),
		...
		ConsumerGroup:   loader.StringDefault("CONSUMER_GROUP", "credit-ledger"),
