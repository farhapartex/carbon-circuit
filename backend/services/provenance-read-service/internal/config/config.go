...
const ServiceName = "provenance-read-service"
...
func Load() (Config, error) {
	...
	config := Config{
		...
		GRPCAddress:     loader.StringDefault("GRPC_ADDRESS", ":9094"),
		...
		DatabaseSchema:  loader.StringDefault("DATABASE_SCHEMA", "provenance_read"),
		...
		ConsumerGroup: loader.StringDefault("CONSUMER_GROUP", "provenance-read"),
	}
