...
func main() {
	...
	names := flag.String("services", "api-gateway,identity-service,billing-service,provenance-service,provenance-read-service,evidence-service,sustainability-service", "comma separated service names")
